<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="breadcrumb">
            <a class="btn btn-primary btn-sm" href="admin/customer/insert" role="button">
            ...
            <a class="btn btn-primary btn-sm" href="admin/customer/recyclebin" role="button">
                ...
                (<?php $total=$this->Mcustomer->customer_trash_count(); echo $total; ?>)
            </a>
        </div>
    </section>
											 ...
											 ?></td>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-success btn-xs"
                                                        href="<?php echo base_url() ?>admin/customer/update/<?php echo $row['id'] ?>"
                                                        role="button">
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-danger btn-xs"
                                                        href="<?php echo base_url() ?>admin/customer/trash/<?php echo $row['id'] ?>"
